...
import 'package:property/screens/broker/quote/quote_request_form_page.dart';
import 'package:property/screens/broker/quote/multiple_quote_request_dialog.dart';
import 'package:property/widgets/broker/broker_widgets.dart';
...
class _BrokerListPageState extends State<BrokerListPage> {
  ...
  Future<Map<String, String>?> _showGuestContactDialog() async {
    return await showDialog<Map<String, String>>(
      context: context,
      builder: (context) => const GuestContactDialog(),
    );
  }
  ...
  Future<void> _requestQuote(Broker broker) async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => QuoteRequestFormPage(
          broker: broker,
  ...
  Future<void> _requestQuoteToTop10() async {
    ...
    final result = await navigator.push<Map<String, dynamic>>(
      MaterialPageRoute(
        builder: (context) => MultipleQuoteRequestDialog(
